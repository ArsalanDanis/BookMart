...
const PopularAuthor = () => {
  ...
  const scrollStep = 300; // Adjust this value for smooth scrolling speed
  const autoPlayInterval = 1000; // Adjust this value for auto play interval in milliseconds
  ...
  return (
    <section className="mt-5 popularComp" >
      <h5
        className="my-4"
